...
const TableComponent = memo(({columnsTable,visibleContent, dataset, title, description = "", onSelectionItem = () => {}, pageSize = 10, extendedTableProperties = {}, tableActions = null, selectedListItems = [{ identifier: "" }]  }) => {
